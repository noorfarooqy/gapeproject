        ...
        <div class="container">
            <div class="row">
                ...
                @foreach($news as $new)
                    <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                        <div class="news-block-two wow fadeInLeft" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                ...
                                <div class="post-info">by {{ $new->AuthorInfo?->name }} , on
                                    {{ $new->created_at->format('Y-m-d') }}</div>
                                <div class="text">{{ substr($new->news_content, 0, 124) }}</div>
                                <div class="link-btn"><a href="blog-single.html">Read More<i
                    ...
                    @if(count($news) <= 1)
                        <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                            <div class="news-block-two wow fadeInLeft" data-wow-delay="300ms"
                                ...
                                <div class="inner-box">
                                    ...
                                    <div class="post-info">by {{ $new->AuthorInfo?->name }} , on
                                        {{ $new->created_at->format('Y-m-d') }}</div>
                                    <div class="text">{!!
                                        substr(htmlspecialchars_decode(stripslashes($new->news_content)), 0, 124) !!}
                                    </div>
                                    <div class="link-btn"><a href="blog-single.html">Read More<i
                                                class="flaticon-slim-right"></i></a></div>
                                </div>
